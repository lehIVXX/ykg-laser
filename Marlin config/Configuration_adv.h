 ...
 */
#define STARTUP_COMMANDS "G28 X0 Y0"
...
#define CUSTOM_MENU_MAIN
  ...
  //#define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M117 Laser Custom GCODES"
  //define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  // Return to status screen after a script
  //#define CUSTOM_MENU_CONFIG_ONLY_IDLE        // Only show custom menu when the machine is idle

  #define CONFIG_MENU_ITEM_1_DESC "Home XY"
  #define CONFIG_MENU_ITEM_1_GCODE "G28 X0 Y0"
  #define CONFIG_MENU_ITEM_1_CONFIRM "M117 XY Homing Done"      // Show a confirmation dialog before this action

  #define CONFIG_MENU_ITEM_2_DESC "Test Laser"
  #define CONFIG_MENU_ITEM_2_GCODE "M117 Laser Test Fire"
  #define CONFIG_MENU_ITEM_2_CONFIRM "M117 Laser Test Done"
/*
